(function(win, options, undefined){
	...
	var Robot = function(config){
		this.con = $.extend({
			...
			/*文本框提示文本*/
			, 'url': 'https://api.smartnlp.cn/cloud/-/'
			/*请求的接口地址*/
			, 'newurl': '#'
			/*新窗口打开的的URL[仅mini模式下有效]*/
			, 'appid': ''
			/*客服图片 80*80像素*/
			, 'callImg': 'https://img.alicdn.com/imgextra/i4/TB1tMo3JpXXXXbwXVXXwu0bFXXX.png'
			/*二维码图片 80*80像素*/
			, 'codeImg': null
			/*机器人欢迎语*/
			, 'welcome': 'Hi，我是$name'
			...
			/*消息发送后文本框是否自动失去焦点*/
			, 'autoblur': false
			, 'logo': 'https://img.alicdn.com/imgextra/i3/TB1UhE3JpXXXXbaXpXXwu0bFXXX.png'
			/*反馈按钮默认颜色*/
	...
	, 'quicks': [
		'我想要离婚怎么办，对方不同意怎么办',
		'朋友欠钱不还怎么办',
		'租房未到期被赶出来，房东违约也不退定金怎么办\n'

	]
	//左侧工具栏，格式{label: '文本',icon: 'icon图标地址60*60', 
	, 'tools': [
		{label: '天气预报',icon: 'https://img.alicdn.com/imgextra/i3/TB16M.kJpXXXXXAXVXXwu0bFXXX.png', href:'#'}
		, {label: '听首歌',icon: 'https://img.alicdn.com/imgextra/i3/TB17xcEJpXXXXXfXXXXwu0bFXXX.png', href:'#'}
		, {label: '指南针',icon: 'https://img.alicdn.com/imgextra/i1/TB10VUAJpXXXXczXXXXwu0bFXXX.png', href:'#'}
		, {label: '常用帮助',icon: 'https://img.alicdn.com/imgextra/i2/TB1FX7tJpXXXXccXpXXwu0bFXXX.png', href:'#'}
	]
	//浮动层zindex
	//, zindex: 999
	//是否显示大窗口模式下的左边
	...
	, 'callImg': 'https://img.alicdn.com/imgextra/i4/TB1tMo3JpXXXXbwXVXXwu0bFXXX.png'
	//二维码图片 80*80像素
	, 'codeImg': 'https://img.alicdn.com/imgextra/i1/TB197MVJpXXXXXuXVXXSutbFXXX.jpg'
	//（废除）点击二维码显示的大图片 262*262像素
	, 'codeBigImg': 'https://img.alicdn.com/imgextra/i1/TB197MVJpXXXXXuXVXXSutbFXXX.jpg'
	//机器人欢迎语
	, 'welcome': 'Hi，我是$name，请输入你的问题（1.问题前添加“dl:”可使用广度查询，2.输入如“第XX条”可查看具体法条，可查询共1258条）'
	//人工客服欢迎语
	...
	//新窗口打开新页面的URL,手机版有效
	, 'newurl': '?mobile'
	, 'logo': 'https://img.alicdn.com/imgextra/i4/TB1tMo3JpXXXXbwXVXXwu0bFXXX.png'
